...
function stringToMove(moveStr) {
        ...
        const fromRow = parseInt(moveStr[1], 10) - 1; //(parseInt(string,radix))
...
export function useGame() {
        ...
        makeEngineMove();
    }, 500); // A small delay of 500ms feels natural

    // It's good practice to clean up timers
    return () => clearTimeout(timerId);

        }, [playerTurn, gameMode, aiColor, gameOver, promotionData, engineModule,board,castlingRights,enPassantTarget]);
